...
import type { ExternalBlob as _ExternalBlob, Product as _Product, ProductInput as _ProductInput, ProductUpdate as _ProductUpdate, StripeSessionStatus as _StripeSessionStatus, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async getOrCreateCart(): Promise<Cart> {
        if (this.processError) {
            try {
                const result = await this.actor.getOrCreateCart();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getSubscriptions(): Promise<Array<string>> {
        if (this.processError) {
            try {
    ...
    async isDiscounted(arg0: bigint): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.isDiscounted(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitOrder(arg0: Array<CartItem>): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async updateProduct(arg0: ProductUpdate): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateProduct(await to_candid_ProductUpdate_n24(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function to_candid_ProductUpdate_n24(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: ProductUpdate): Promise<_ProductUpdate> {
